...
public class RabbitConfiguration {
     ...
     */
    public static final String WORKING_EXCHANGE = "working_direct_exchange6";

    /**
     * demoDer Warteschlangenname des Unternehmens
     */
    public static final String WORKING_DEMO_QUEUE = "working_demo_queue6";

    /**
     * demoDer Routenschlüssel des Unternehmens
     */
    public static final String WORKING_DEMO_ROUTINGKEY = "working_demo_key6";
     ...
     */
    public final static String WORKING_RETRY_EXCHANGE_NAME = "working_retry_exchange6";

    /**
     * workingModul-DEMO-Serviceverzögerungswarteschlange
     */
    public final static String WORKING_DEMO_RETRY_QUEUE_NAME = "working_demo_retry_queue6";

    /**
     * workingModul DEMO Verzögerungswarteschlangen-Routenschlüssel
     */
    public final static String WORKING_DEMO_RETRY_ROUTING_KEY = "working_demo_retry_key6";
     ...
     */
    public final static String FAIL_QUEUE_NAME = "fail_queue6";

    /**
     * Totbuchstaben-Schalter
     */
    public final static String FAIL_EXCHANGE_NAME = "fail_exchange6";

    /**
     * Weiterleiten unzustellbarer Buchstaben
     */
    public final static String FAIL_ROUTING_KEY = "fail_routing6";
