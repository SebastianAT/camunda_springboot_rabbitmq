...
public class receiveEvent implements JavaDelegate {
	...
	public void receiveMessage(String message) {
        try {
          //  Response response = messageProcessor.processMessage(message);
        	System.out.println("receiveEvent class in receiveMessage method " + message);
        }catch(Exception e){
	...
	public void receiveMessage2(String message) {
        try {
          //  Response response = messageProcessor.processMessage(message);
        	System.out.println("receiveEvent class in receiveMessage method executed with call " + message);
        }catch(Exception e){
            // @TODO: Fix up error catching with the service
            System.out.println("ERROR: " + e.getMessage());
        }
